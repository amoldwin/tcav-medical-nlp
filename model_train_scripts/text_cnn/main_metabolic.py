...
train_dataset = list(zip(train_inputs, train_df['label'].astype(int)))
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=64, shuffle=True)


val_dataset = list(zip(val_inputs, val_df['label'].astype(int)))
val_loader = torch.utils.data.DataLoader(val_dataset, batch_size=64, shuffle=True)


test_dataset = list(zip(test_inputs, test_df['label'].astype(int)))
