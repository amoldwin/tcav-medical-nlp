...
def preprocess_function(examples):
    examples['labels'] = examples['nicu_los']
...
val_test_ds['labels']==val_dataset['labels']+test_dataset['labels']
...
model = WeightedBertForSequenceClassification.from_pretrained("bionlp/bluebert_pubmed_mimic_uncased_L-12_H-768_A-12", weight_list=weight, num_labels=2)
