...
def plot_results(results, random_counterpart=None, random_concepts=None, num_random_exp=100,
  ...
  for i, conc in enumerate(plot_concepts):
    txtbox_str = txtbox_str +str(i)+': '+ conc +'\n'
  ax.set_xticklabels(list(range(len(plot_concepts))))
  ax.legend()
  props = dict(boxstyle='round', facecolor='wheat', alpha=0.5)
  ax.text(1.05, 0.95, txtbox_str, transform=ax.transAxes, fontsize=10,
