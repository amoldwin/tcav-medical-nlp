...
import json
with open(scores_dir+'distilbert_relative_layers/weekday_nocad_results_distilbert_final_relative_mimic_savecavs_' + ckpt.split('/')[-1] +str(layer_number)+'.json', 'w') as jfile:
