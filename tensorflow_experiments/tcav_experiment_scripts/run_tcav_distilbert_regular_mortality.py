...
cav_dir = './cavs_distilbert_regular/'
...
concepts = concepts + [x for x in os.listdir(concepts_dir) if x.startswith('filtered') and 'disch' not in x]
...
mytcav = tcav.TCAV(sess,
                  ...
                  # random_concepts = [concept for concept in os.listdir('../concept_listfiles') if concept.startswith('disch_random500') and 'encode' not in concept][:10])
