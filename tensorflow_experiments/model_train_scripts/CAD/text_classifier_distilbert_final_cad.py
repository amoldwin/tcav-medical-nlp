...
#         print(classification_report(self.y_true,y_pred,output_dict=False))
        ...
        scores_df.to_csv(source_dir+'bertcheckpoints/distilbert/distilbert_cad_final'+str(epoch)+'scores.csv')
        try:
            self.model.save_pretrained(source_dir+'bertcheckpoints/distilbert/distilbert_cad_final'+str(epoch)+'.h5')
        except:
            print('save failed')
            pass
