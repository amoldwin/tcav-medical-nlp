...
class TCAV(object):
    ...
    def run(self, num_workers=1, run_parallel=False):
    ...
    def _run_single_set(self, param):
        ...
        #remove if there is any input dependency (whenever using a CAV layer other than penultimate)
        acts[target_class][bottleneck]=np.asarray([acts[target_class][bottleneck][0]])
        # Get CAVs
        ...
        result = {
            ...
            'val_directional_dirs_median':
                np.median(val_directional_dirs),
