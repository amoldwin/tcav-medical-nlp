...
python tcav_experiment.py --ckpt_path /data/moldwinar/torch_tcav/model_train_scripts/checkpoints/CCS_just_residual_0/checkpoint-133893 \
--num_trials 500 \
